 ...
 */
public class Vm implements List<Vm> {
	...
	@Override
	public boolean addAll(Collection<? extends Vm> collection) {
		return false;
	}

	@Override
	public boolean addAll(int i, Collection<? extends Vm> collection) {
		return false;
	}
	...
	@Override
	public ListIterator<Vm> listIterator(int i) {
		return null;
	}

	@Override
	public List<Vm> subList(int i, int i1) {
		return null;
	}
}
