...
public abstract class CloudletScheduler {
	 ...
	 * @post $none
	 */
	public abstract Cloudlet migrateCloudlet(DatacenterBroker broker, Cloudlet cloudlet);

	/**
	 * Get utilization created by all cloudlets.get
	 * 
	 * @param time the time
